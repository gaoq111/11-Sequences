...
def run_test_count_negatives():
    ...
    expected = 3
    actual = count_negatives((-4, -1, -9, 10))
    print()
    print('Test 6 expected:', expected)
    print('       actual:  ', actual)

    expected = 2
    actual = count_negatives((4, 3, -7, -100))
    print()
...
def run_test_count_short_ones():
    ...
    expected = 2
    seq = [[2, 3], [1, 1, 1], [123123, 2223, 5134,999], 'hi']
    actual = count_short_ones(seq)
    print()
    ...
    expected = 2
    seq = ['we are the best', [], [29120381239,3120398123,232413], ['hi']]
    actual = count_short_ones(seq)
    print()
